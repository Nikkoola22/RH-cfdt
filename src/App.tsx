            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              ...
              >
                <div className="relative z-10 flex flex-col items-center gap-6">
                  ...
                  <h4 className="text-2xl font-bold text-gray-800 group-hover:text-amber-700">Recherche juridique</h4>
              ...
              >
                <div className="relative z-10 flex flex-col items-center gap-6">
                  ...
                  <h4 className="text-2xl font-bold text-gray-800 group-hover:text-indigo-700">IA fonction publique</h4>
